...
🚀 VIRAL PREDICTION
-------------------
• Virality Score: ${results.prediction.viralityScore}/100
• Assessment: ${results.prediction.assessment}
• Predicted Views: ${results.prediction.views}

📊 DETAILED SCORES
------------------
• Hook: ${results.scores.hookScore}/100
• Pacing: ${results.scores.pacingScore}/100
• Emotion: ${results.scores.emotionScore}/100
• Storytelling: ${results.scores.storytellingScore}/100
...
`;
    ...
    const handleShare = async () => {
        ...
        const shareData = {
            ...
            text: `Check out my ViralPilot analysis! 🚀\nScore: ${results.prediction.viralityScore}/100\nPrediction: ${results.prediction.views} views\nAssessment: ${results.prediction.assessment}`,
